...
<head>
    ...
    <title>St Mary Dental Clinic</title>
...
<div class='box'>
  <div class='box-form'>
    ...
    <p style="color:blue;"><?php echo $this->session->flashdata('message'); ?></p>
      <form class='fieldset-body' id='login_form' autocomplete="off" role="form" method="post" action="<?php echo base_url(); ?>clinic/login">
  ...
  <div class='box-info'>
    					...
    					<button onclick="Conatct System Administrator" class='b-support' title='Forgot Password?'> Forgot Password?</button>
    <button href="mailto://agabaandre@gmail.com" class='b-support' title='Contact Support'> Contact Support</button>
    					<div class='line-wh'></div>
    <!-- <button onclick="" class='b-cta' title='Sign up now!'> CREATE ACCOUNT</button> -->
  				</div>
</div>

<div class='icon-credits'> <a href="http://health.go.ug" title="MOH" target="_blank">St. Mary's Dental Clinic <?php echo date('Y');?></a></div>
