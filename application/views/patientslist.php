...
<div id="printableArea">                            
                <div class="box-header with-border">
                  <h5 class="box-title">Patients Contact List</h5>
				  <p class="danger"></p>
                </div>
                    ...
                    foreach ($patients as $row) {
					 ...
					 <tr>
					    <td><?php echo $i++; ?></td>
					    <td width><a href="<?php echo base_url()?>clinic/userprofile/<?php echo  $row->mobile;?>" target="_blank"><?php echo $row->name; ?> </a> </td>
