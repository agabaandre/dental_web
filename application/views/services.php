  ...
  <div class="col-md-4">
      <p>Add Services</p>
	          <form method="post" action="<?php echo base_url();?>Clinic/services" autocomplte="off">
	  	             <div id="">
					<label>Name: *</label>
                      <input class="form-control" name="name" id="title" value="" placeholder="Name" type="text" required autocomplete="off">
				   </div>
                   <div id="">
				   ...
				   <div id="">
                      ...
                      <input type="text" class="form-control" name="description" id="" value="" placeholder="Description" type="text" max-length="200">
				   </div>
